...
void Scene::Init()
{
	...
	// =================================================
	std::shared_ptr<InteractiveObject> hintTest1 = std::make_shared<Hint>("Le niveau de radioactivite de doit \n pas etre au dessus de 0.3");
	std::shared_ptr<InteractiveObject> hintTest2 = std::make_shared<Hint>("L eau, c est pour les faibles.");
	std::shared_ptr<InteractiveObject> hintTest3 = std::make_shared<Hint>("Une atmosphere est necessaire.");
